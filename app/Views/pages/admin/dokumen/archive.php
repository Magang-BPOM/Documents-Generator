...
<div class="max-w-full mx-auto p-6 sm:px-6 lg:px-6">
    <div class="bg-white dark:bg-neutral-900 shadow-lg rounded-xl p-6">
                ...
                <div class="flex justify-end gap-x-2">
                    ...
                    <div class="sm:col-span-2 md:grow">
                        <div class="flex justify-end gap-x-2">
                            ...
                            <!-- button untuk memulihkan data yang diarsip -->
     ...
     <!-- Tabel untuk menampilkan data dokumen arsip-->
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-neutral-900 dark:divide-neutral-800">
                    ...
                    foreach ($arsip_surat as $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                  <!-- Aksi untuk mendownload Surat Perjalanan Dinas -->
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
         // Mengatur tanggal dalam format Indonesia
        moment.locale('id');
    ...
    // Fungsi untuk memulihkan data yang dipilih
