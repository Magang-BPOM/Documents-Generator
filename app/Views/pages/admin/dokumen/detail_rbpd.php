            ...
            <table class="w-full border-collapse border border-gray-300 mt-4">
                ...
                <tr class="even:bg-gray-50 odd:bg-white">
                    ...
                    <td class="border border-gray-300 p-3 text-center">
                        ...
                        <?php else: ?>
                            <a href="<?= base_url("admin/dokumen/createRBPD/{$surat['id']}/{$user['user_id']}") ?>" class="inline-block px-4 py-2 text-white bg-green-600 rounded hover:bg-green-700">Buat RBPD</a>
                        <?php endif; ?>
                    </td>
