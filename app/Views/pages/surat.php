...
<div class="max-w-full mx-auto p-6 sm:px-6 lg:px-6">
    <div class="bg-white dark:bg-neutral-900 shadow-lg rounded-xl p-6">
        <div class="flex items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-neutral-100">Dokumen Surat</h2>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-neutral-800">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Menimbang</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Dasar</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-neutral-900 dark:divide-neutral-800">
                    <?php foreach ($surat as $item): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap"><?= esc($item['menimbang']) ?></td>
                            <td class="px-6 py-4 whitespace-nowrap"><?= esc($item['dasar']) ?></td>
                            <td class="px-6 py-4 whitespace-nowrap"><?= esc($item['untuk']) ?></td>
                            <td class="px-6 py-4 whitespace-nowrap" data-date="<?= esc($item['ttd_tanggal']) ?>"></td>
