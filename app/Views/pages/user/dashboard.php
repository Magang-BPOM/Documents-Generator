...
<div class="max-w-full mx-auto">
    <div class="bg-white dark:bg-neutral-900 shadow-lg rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-5 ">
            ...
            <div class="bg-red-500 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold"><?= $total_surat ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-500 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-lg font-semibold">Surat Aktif</h2>
                        <p class="text-2xl font-bold"><?= $surat_aktif ?></p>
                    </div>
                </div>
            </div>

            <!-- Surat Arsip -->
            <div class="bg-yellow-500 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <svg class="w-8 h-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-4">
                        <h2 class="text-lg font-semibold">Surat Arsip</h2>
                        <p class="text-2xl font-bold"><?= $surat_arsip ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-blue-500 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-lg font-semibold">Surat Baru Bulan Ini</h2>
                        <p class="text-2xl font-bold"><?= $surat_baru_bulan_ini ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-10 bg-white p-6 rounded-lg  dark:bg-neutral-800 dark:border-neutral-700">
